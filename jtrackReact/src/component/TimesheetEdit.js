...
class TimesheetEdit extends Component {
    ...
    componentDidMount() {
        ...
        let timesheetId = params.timesheetId;

        this.getTimesheet(timesheetId);
        this.getUserList();
        this.getJobList();
    ...
    handleSubmit(event) {
        ...
        TimesheetService.updateTimesheet(this.state.timesheet)
        .then(res => {
            this.updateMessage('');
            try{
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td colSpan="1" rowSpan="1" align="left" valign="middle">
                                                        {/* <input name="userId" value={this.state.timesheet.userId} onChange={this.handleChange} disabled={true} /> */}
                                                        <select name="userId" value = {this.state.timesheet.userId} onChange={this.handleChange} disabled={true}>
                                                            <option value=""></option>
                                                ...
                                                <tr>
                                                    ...
                                                    <td colSpan="1" rowSpan="1" align="left" valign="middle">
                                                        <select name="jobNo" value = {this.state.timesheet.jobNo} onChange={this.handleChange} disabled={true}>
                                                            <option value=""></option>
                                                ...
                                                <tr>
                                                    ...
                                                    <td  colSpan="1" rowSpan="1" align="left" valign="middle">
                                                        <input type="date" name="workedDate" value = {this.state.timesheet.workedDate} onChange={this.handleChange} disabled={true} />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td nowrap="nowrap" align="right">
...
export default withRouter(TimesheetEdit);