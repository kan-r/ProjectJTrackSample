...
class JobPriorityCreate extends Component {
    ...
    componentDidMount() {
        ...
        let jobPriority = params.jobPriority;
        this.getJobPriority(jobPriority);
    }
    ...
    getJobPriority(jobPriority){
        ...
        .then(res => {
            this.updateMessage('');
            this.setState({ jobPriority: res.data })
        })
        .catch(err => {
    ...
    handleSubmit(event) {
        ...
        JobPriorityService.updateJobPriority(this.state.jobPriority)
        .then(res => {
            this.updateMessage('');
            try{
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td  colSpan="1" rowSpan="1" align="left" valign="middle">
                                                        <input name="jobPriority" value={this.state.jobPriority.jobPriority} onChange={this.handleChange} disabled={true} />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td nowrap="nowrap" align="right">
