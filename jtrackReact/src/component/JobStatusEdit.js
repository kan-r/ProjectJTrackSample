...
class JobStatusCreate extends Component {
    ...
    componentDidMount() {
        ...
        let jobStatus = params.jobStatus;
    ...
    getJobStatus(jobStatus){
        ...
        .then(res => {
            this.updateMessage('');
            this.setState({ jobStatus: res.data })
        })
        .catch(err => {
    ...
    handleSubmit(event) {
        ...
        JobStatusService.updateJobStatus(this.state.jobStatus)
        .then(res => {
            this.updateMessage('');
            try{
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td  colSpan="1" rowSpan="1" align="left" valign="middle">
                                                        <input name="jobStatus" value={this.state.jobStatus.jobStatus} onChange={this.handleChange} disabled={true} />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td nowrap="nowrap" align="right">
