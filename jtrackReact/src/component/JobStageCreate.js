...
class JobStageCreate extends Component {
    ...
    handleSubmit(event) {
        ...
        let jobStage  = this.state.jobStage.jobStage;
        if(jobStage == null || jobStage.trim() === ''){
            this.updateMessage('Job Stage is required', true);
            return;
        }

        JobStageService.addJobStage(this.state.jobStage)
        .then(res => {
            this.updateMessage('');
            try{
                ...
                <form onSubmit={this.handleSubmit}>
                    ...
                    <div className="form-region-2">
                        <table cellPadding="0" border="0" cellSpacing="0" summary="" className="form-standard">
                            <thead>
                                <tr>
                                    <th><div>Create Job Stage</div></th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td  colSpan="1" rowSpan="1" align="left" valign="middle">
                                                        <input name="jobStage" value={this.state.jobStage.jobStage} onChange={this.handleChange} />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td nowrap="nowrap" align="right">
